...
//考试
Route::get('/weixin/form','Weixin\weixinJsController@form');
Route::post('/weixin/forms','Weixin\weixinJsController@forms');
Route::get('/weixin/taten','Weixin\weixinJsController@getWXAccessToken');
//api 接口测试
